...
/**
 * @deprecated FieldDataを使用してください
 */
export type ImmutableField = FieldData

/**
 * @deprecated createEmptyFieldを使用してください
 */
export const createField = createEmptyField

/**
 * @deprecated getPuyoAtを使用してください
 */
export const getPuyo = getPuyoAt

/**
 * @deprecated placePuyoAtを使用してください
 */
export const setPuyo = placePuyoAt

/**
 * @deprecated removePuyoAtを使用してください
 */
export const removePuyo = removePuyoAt

/**
 * @deprecated isEmptyAtを使用してください
 */
export const isEmpty = isEmptyAt

/**
 * @deprecated removePuyosAtを使用してください
 */
export const removePuyos = removePuyosAt

/**
 * @deprecated getAllPuyosWithPositionsを使用してください
 */
export const getAllPuyos = getAllPuyosWithPositions
