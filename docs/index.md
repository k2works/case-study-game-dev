...
### 📝 アーキテクチャ決定記録
- [ADR一覧](./adr/index.md) - **📚 10個の重要な技術・戦略決定**を記録。AI機能投入決定を含む全体戦略。（イテレーション1で全ADR実装完了✅）
...
## 🚀 Phase 2-3実績・進行中
- [開発ドキュメント](./development) - **✅ イテレーション1完了実績**を含む開発手順とガイドライン。TDD + 関数型アプローチの効果実証。
