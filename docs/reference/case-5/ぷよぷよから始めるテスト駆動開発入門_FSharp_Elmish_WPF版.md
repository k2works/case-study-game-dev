...
│       │   └── Bindings.fs        # Elmish Bindings
│       ├── MainWindow.xaml        # メインウィンドウXAML
│       ├── MainWindow.xaml.fs     # メインウィンドウコード
│       ├── App.xaml               # アプリケーションXAML
│       └── App.xaml.fs            # アプリケーションコード
├── tests/
│   └── PuyoPuyo.Tests/
│       ├── Domain/
│       │   ├── BoardTests.fs
...
open Xunit
open FsUnit.Xunit
open PuyoPuyo.WPF.Domain.Types
