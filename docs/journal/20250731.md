...
```
docs: add deployment guide for Vercel and update related documentation
```
...
- A	"docs/operation/\343\203\207\343\203\227\343\203\255\343\202\244.md"

### 変更内容

```diff
commit f97907ea7062494788772d813912fa2f52ee760c
Author: k2works <kakimomokuri@gmail.com>
Date:   Thu Jul 31 14:03:38 2025 +0900

    docs: add deployment guide for Vercel and update related documentation

diff --git a/.claude/settings.local.json b/.claude/settings.local.json
new file mode 100644
index 0000000..6869b0c
--- /dev/null
...
diff --git "a/docs/operation/\343\203\207\343\203\227\343\203\255\343\202\244.md" "b/docs/operation/\343\203\207\343\203\227\343\203\255\343\202\244.md"
new file mode 100644
index 0000000..2227bee
--- /dev/null
+++ "b/docs/operation/\343\203\207\343\203\227\343\203\255\343\202\244.md"
@@ -0,0 +1,178 @@
+# デプロイ
+
+## 概要
...
```
fix: configure Vercel to serve from app directory
```
...
```diff
commit 9bc2ea93fd1b9d4452ed9ae3b52f36e270ddd767
Author: k2works <kakimomokuri@gmail.com>
Date:   Thu Jul 31 13:59:41 2025 +0900

    fix: configure Vercel to serve from app directory

diff --git a/vercel.json b/vercel.json
new file mode 100644
index 0000000..fd357b8
--- /dev/null
+++ b/vercel.json
@@ -0,0 +1,9 @@
+{
...
```
feat: add Puyo Puyo game implementation with HTML, CSS, and JavaScript
```
...
```diff
commit 25ef80232f1112bdcbc156364666280aa6233cd9
Author: k2works <kakimomokuri@gmail.com>
Date:   Thu Jul 31 13:47:26 2025 +0900

    feat: add Puyo Puyo game implementation with HTML, CSS, and JavaScript

diff --git a/app/index.html b/app/index.html
new file mode 100644
index 0000000..47509d8
--- /dev/null
+++ b/app/index.html
@@ -0,0 +1,57 @@
+<!DOCTYPE html>
...
+</html>
\ No newline at end of file
diff --git a/app/puyo.js b/app/puyo.js
new file mode 100644
index 0000000..ab5b1fc
--- /dev/null
+++ b/app/puyo.js
@@ -0,0 +1,439 @@
+class PuyoGame {
...
```
chore: add empty CLAUDE.md file
```
...
```diff
commit 4aaf5c45ae9ed9dd9a3a6b8cbc00bf866c2d3e30
Author: k2works <kakimomokuri@gmail.com>
Date:   Thu Jul 31 13:37:48 2025 +0900
...
```
docs: add setup and operation documentation with project structure and usage instructions
```

### 変更されたファイル

- M	README.md
- A	docs/journal/20250731.md
- A	docs/operation/index.md
- A	"docs/operation/\343\202\273\343\203\203\343\203\210\343\202\242\343\203\203\343\203\227.md"

### 変更内容

```diff
commit 6938b7c00775eb8108d63bc889314e9653eb920c
Author: k2works <kakimomokuri@gmail.com>
Date:   Thu Jul 31 13:20:56 2025 +0900

    docs: add setup and operation documentation with project structure and usage instructions

diff --git a/README.md b/README.md
index 2c5c1e2..53b704a 100644
--- a/README.md
+++ b/README.md
@@ -2,9 +2,13 @@
...
\ No newline at end of file
diff --git a/docs/journal/20250731.md b/docs/journal/20250731.md
new file mode 100644
index 0000000..1b4951b
--- /dev/null
+++ b/docs/journal/20250731.md
@@ -0,0 +1,4904 @@
+# 作業履歴 2025-07-31
+
+## 概要
...
+- [アーキテクチャ決定ログ](../adr/)
\ No newline at end of file
diff --git "a/docs/operation/\343\202\273\343\203\203\343\203\210\343\202\242\343\203\203\343\203\227.md" "b/docs/operation/\343\202\273\343\203\203\343\203\210\343\202\242\343\203\203\343\203\227.md"
new file mode 100644
index 0000000..c80bb1d
--- /dev/null
+++ "b/docs/operation/\343\202\273\343\203\203\343\203\210\343\202\242\343\203\203\343\203\227.md"
@@ -0,0 +1,121 @@
+# セットアップ
+
+## 概要
